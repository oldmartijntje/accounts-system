...
def closeAccount(name, list1, data1, appDataDict, achievements, collectables):#close the account
...
def easyImportable(appName = 'defaultAppName',defaultList = ['this List contains all your app data', 'don\'t keep this, here should be your data a player should have on it\'s first launch', 69, 'you have opened a default app once, wow']):
    '''kaas'''
    ...
    if appName not in appDataDict:#if the user hasn't played before
        appDataDict[appName] = defaultList
    else:
        pass
        #print(appDataDict[appName])#prints your data, just to show you how it works
    return name, list1, appDataDict, num1, num2, data1, data2, data3, achievements, collectables, startTime, data
